# TiaCAD Documentation

Complete documentation for TiaCAD - declarative parametric CAD in YAML.
...
**Start here if you're learning TiaCAD**

- **[Tutorial](user/TUTORIAL.md)** - Step-by-step introduction to TiaCAD
- **[Examples Guide](user/EXAMPLES_GUIDE.md)** - Comprehensive guide to all examples
- **[YAML Reference](user/YAML_REFERENCE.md)** - Complete YAML syntax reference
- **[Glossary](user/GLOSSARY.md)** - Terminology and concepts
- **[Auto References Guide](user/AUTO_REFERENCES_GUIDE.md)** - Automatic spatial referencing system
...
### 📦 [Archive](archive/)
**Historical planning and status documents**

- Planning docs, roadmaps, and status reports
- Kept for historical reference
- Not maintained for current version
...
**New to TiaCAD?**
1. Start with [User Tutorial](user/TUTORIAL.md)
2. Explore [Examples](../examples/)
3. Reference [YAML Syntax](user/YAML_REFERENCE.md)

**Contributing?**
1. Read [Developer Guide](developer/)
2. Set up testing with [Testing Guide](developer/TESTING_GUIDE.md)
3. Understand [Architecture](architecture/)
...
- **[Examples Directory](../examples/)** - Working YAML examples
- **[Changelog](../CHANGELOG.md)** - Version history
- **[Release Notes](../RELEASE_NOTES_V3.md)** - Latest release details
